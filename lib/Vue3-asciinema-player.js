...
(function(A) {
  ...
  function I() {
    ...
    var v = Object.getPrototypeOf, L = v && v(v(d([])));
    L && L !== C && Q.call(L, i) && (S = L);
    ...
    return N.prototype = y, E(b, "constructor", {
      ...
      dispatchException: function(r) {
        ...
        var a = this;
        function l(J, m) {
          return o.type = "throw", o.arg = r, a.next = J, m && (a.method = "next", a.arg = void 0), !!m;
        }
...
function Z(A, g, I) {
  ...
  const B = Eg(A, g, !0, 0);
  return B.pending = oA, B.observers = null, B.observerSlots = null, B.comparator = I.equals || void 0, GA(B), Lg.bind(B);
}
function Sg(A) {
  if (uA)
    return A();
...
function EI(A, g, I = {}) {
  ...
  return OA(() => mA(Q)), () => {
    let i = A() || [], t, n;
    return EA(() => {
      let w = i.length, h, f, k, N, y, S, v, L, b;
      if (w === 0)
        ...
        for (k = new Array(w), N = new Array(w), e && (y = new Array(w)), S = 0, v = Math.min(E, w); S < v && B[S] === i[S]; S++)
          ;
        for (v = E - 1, L = w - 1; v >= S && L >= S && B[v] === i[L]; v--, L--)
          k[L] = C[v], N[L] = Q[v], e && (y[L] = e[v]);
        for (h = /* @__PURE__ */ new Map(), f = new Array(L + 1), n = L; n >= S; n--)
...
function JA(A, g) {
  return bg.decode(vA().subarray(A, A + g));
}
function _A(A) {
  var g = hA(A);
...
var HA = 0, LA = new TextEncoder("utf-8"), cI = typeof LA.encodeInto == "function" ? function(A, g) {
...
function Kg(A, g, I) {
  if (I === void 0) {
    var B = LA.encode(A), C = g(B.length);
    return vA().subarray(C, C + B.length).set(B), HA = B.length, C;
  }
  for (var Q = A.length, E = g(Q), e = vA(), i = 0; i < Q; i++) {
  ...
  if (i !== Q) {
    ...
    var n = vA().subarray(E + i, E + Q), s = cI(A, n);
    i += s.written;
  }
  return HA = i, E;
}
        ...
        return R.wrap(function(y) {
          for (; ; )
            switch (y.prev = y.next) {
              case 0:
                return e = 0, i = this.feed.bind(this), t = this.now.bind(this), n = function(v, L) {
                  return window.setTimeout(v, L / C.speed);
                }, s = function(v, L) {
                  return window.setInterval(v, L / C.speed);
                }, w = function(v, L) {
                  C.resetVt(v, L);
                }, h = function() {
                  e++, C.loop === !0 || typeof C.loop == "number" && e < C.loop ? C.restart() : (C.state = "finished", C.dispatchEvent("ended"));
                }, f = !1, k = function(v) {
                  v && !f ? (f = !0, C.dispatchEvent("waiting")) : !v && f && (f = !1, C.dispatchEvent("play"));
                }, y.next = 11, FI;
              case 11:
...
const JI = {
  get(A, g, I) {
    ...
    if (g === qA || g === "__proto__")
      return B;
    const C = IA(B);
    if (Jg() && (typeof B != "function" || A.hasOwnProperty(g))) {
      let Q, E;
...
function aA(A, g, I = []) {
  ...
  let Q = g[0];
  typeof Q == "function" && (Q = Q(C, I), Q === C) || B === void 0 && Q == null || (Q = DA(Q), B === void 0 || IA(C) && IA(Q) && !Array.isArray(Q) ? LI(C, Q) : X(A, B, Q));
}
function xg(A, g) {
  const I = DA(A || {}), B = jg(I);
  function C(...Q) {
...
var _I = function(A) {
  ...
  g.addEventListener("starting", function() {
    ...
    t === void 0 && (t = requestAnimationFrame(v));
  });
  var y = function() {
    E({
  ...
  vg(/* @__PURE__ */ K(/* @__PURE__ */ R.mark(function u() {
    var o, G, F, J;
    return R.wrap(function(p) {
      for (; ; )
        switch (p.prev = p.next) {
          ...
          case 5:
            o = p.sent, G = o.isPausable, F = o.isSeekable, J = o.poster, E({
              isPausable: G,
              isSeekable: F
            }), J !== void 0 && !I && E({
              lines: J.lines,
  ...
  var v = function() {
    ...
    if (!!Q.charW) {
      ...
      if (F === "both" || Q.isFullscreen) {
        var J = Q.containerW / Q.containerH, m = o / G;
        J > m ? F = "height" : F = "width";
      }
      if (F === !1 || F === "none")
        return {};
      if (F === "width") {
    ...
    if (Q.isFullscreen) {
      ...
      var F, J;
      ((F = (J = h.requestFullscreen) !== null && J !== void 0 ? J : h.webkitRequestFullscreen) !== null && F !== void 0 ? F : function() {
      }).apply(h);
    }
  }, W = function(o) {
    ...
    var o;
    return (o = L()) === null || o === void 0 ? void 0 : o.scale;
  }, D = function() {
    ...
    return typeof F == "function" ? F(o) : f = o, o.$$mousemove = function() {
      ...
      return m !== J._v$ && u.classList.toggle("hud", J._v$ = m), p !== J._v$2 && (o.className = J._v$2 = p), J._v$3 = WA(o, dA, J._v$3), J;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0
...
function CB(A, g, I) {
  ...
  function L() {
    return L = K(/* @__PURE__ */ R.mark(function d() {
      var M, c, r;
    ...
    n = new WebSocket(I), n.binaryType = "arraybuffer", n.onopen = function() {
      ...
      if (typeof N.data == "string") {
        ...
        if (y.cols !== void 0 || y.width !== void 0) {
          var S, v;
          f(), E((S = y.cols) !== null && S !== void 0 ? S : y.width, (v = y.rows) !== null && v !== void 0 ? v : y.height);
        } else
          s.pushEvent(y);
      } else
...
const DB = (A, g) => {
  ...
  setup(A) {
    ...
    return Wg(() => {
      var Q, E;
      fB(
        g.file || "https://asciinema.org/a/332602.cast?dl=1",
        I.value,
        {
          loop: (Q = g.loop) != null ? Q : !1,
          theme: (E = g.theme) != null ? E : C
        }
      );
    }), (Q, E) => (Xg(), Vg("div", yB, [
      zg("div", {
...
}, cA = /* @__PURE__ */ DB(GB, [["__scopeId", "data-v-ee91f4f6"]]);
cA.install = (A) => {
