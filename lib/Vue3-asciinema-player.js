import { ref as Og, nextTick as Wg, openBlock as Xg, createElementBlock as Vg, createElementVNode as zg } from "vue";
function rg(A, g, I, B, C, Q, E) {
  try {
    var e = A[Q](E), i = e.value;
  } catch (t) {
    I(t);
    return;
  }
  e.done ? g(i) : Promise.resolve(i).then(B, C);
}
function K(A) {
  return function() {
...
function ZA(A, g, I) {
  return g && og(A.prototype, g), I && og(A, I), Object.defineProperty(A, "prototype", {
    writable: !1
  }), A;
}
var dg = { exports: {} }, kg = { exports: {} };
(function(A) {
  function g(I) {
    return A.exports = g = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(B) {
      return typeof B;
    } : function(B) {
      return B && typeof Symbol == "function" && B.constructor === Symbol && B !== Symbol.prototype ? "symbol" : typeof B;
    }, A.exports.__esModule = !0, A.exports.default = A.exports, g(I);
  }
  A.exports = g, A.exports.__esModule = !0, A.exports.default = A.exports;
})(kg);
(function(A) {
  var g = kg.exports.default;
  function I() {
    A.exports = I = function() {
      return B;
    }, A.exports.__esModule = !0, A.exports.default = A.exports;
    var B = {}, C = Object.prototype, Q = C.hasOwnProperty, E = Object.defineProperty || function(c, r, a) {
      c[r] = a.value;
    }, e = typeof Symbol == "function" ? Symbol : {}, i = e.iterator || "@@iterator", t = e.asyncIterator || "@@asyncIterator", n = e.toStringTag || "@@toStringTag";
    function s(c, r, a) {
    ...
    function w(c, r, a, l) {
      var D = r && r.prototype instanceof k ? r : k, u = Object.create(D.prototype), o = new P(l || []);
      return E(u, "_invoke", {
        value: sA(c, a, o)
      }), u;
    }
    ...
    var J = Object.getPrototypeOf, v = J && J(J(d([])));
    v && v !== C && Q.call(v, i) && (S = v);
    var b = y.prototype = k.prototype = Object.create(S);
    function T(c) {
    ...
    function W(c, r) {
      function a(D, u, o, G) {
        var F = h(c[D], c, u);
        if (F.type !== "throw") {
          var L = F.arg, m = L.value;
          return m && g(m) == "object" && Q.call(m, "__await") ? r.resolve(m.__await).then(function(p) {
            a("next", p, o, G);
          }, function(p) {
            a("throw", p, o, G);
          }) : r.resolve(m).then(function(p) {
            L.value = p, o(L);
          }, function(p) {
            return a("throw", p, o, G);
          });
        }
        G(F.arg);
      }
      ...
      E(this, "_invoke", {
        value: function(u, o) {
          function G() {
            return new r(function(F, L) {
              a(u, o, F, L);
            });
          }
          return l = l ? l.then(G, G) : G();
        }
      });
    }
    function sA(c, r, a) {
      ...
      return function(D, u) {
        ...
        for (a.method = D, a.arg = u; ; ) {
          ...
          var F = h(c, r, a);
          if (F.type === "normal") {
            if (l = a.done ? "completed" : "suspendedYield", F.arg === f)
              continue;
            return {
              value: F.arg,
              done: a.done
          ...
          F.type === "throw" && (l = "completed", a.method = "throw", a.arg = F.arg);
        }
      };
    }
    function BA(c, r) {
      var a = c.iterator[r.method];
      if (a === void 0) {
        if (r.delegate = null, r.method === "throw") {
          if (c.iterator.return && (r.method = "return", r.arg = void 0, BA(c, r), r.method === "throw"))
            return f;
          r.method = "throw", r.arg = new TypeError("The iterator does not provide a 'throw' method");
        }
        return f;
      }
      var l = h(a, c.iterator, r.arg);
      if (l.type === "throw")
        return r.method = "throw", r.arg = l.arg, r.delegate = null, f;
      var D = l.arg;
      return D ? D.done ? (r[c.resultName] = D.value, r.next = c.nextLoc, r.method !== "return" && (r.method = "next", r.arg = void 0), r.delegate = null, f) : D : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, f);
    }
    function QA(c) {
      var r = {
        tryLoc: c[0]
      };
      1 in c && (r.catchLoc = c[1]), 2 in c && (r.finallyLoc = c[2], r.afterLoc = c[3]), this.tryEntries.push(r);
    }
    function z(c) {
      var r = c.completion || {};
    ...
    function P(c) {
      this.tryEntries = [{
        tryLoc: "root"
      }], c.forEach(QA, this), this.reset(!0);
    }
    function d(c) {
      if (c) {
        var r = c[i];
        ...
        if (typeof c.next == "function")
          return c;
        if (!isNaN(c.length)) {
          var a = -1, l = function D() {
            for (; ++a < c.length; )
              if (Q.call(c, a))
                return D.value = c[a], D.done = !1, D;
    ...
    return N.prototype = y, E(b, "constructor", {
      value: y,
      configurable: !0
    }), E(y, "constructor", {
      value: N,
      configurable: !0
    }), N.displayName = s(y, n, "GeneratorFunction"), B.isGeneratorFunction = function(c) {
      var r = typeof c == "function" && c.constructor;
      return !!r && (r === N || (r.displayName || r.name) === "GeneratorFunction");
    }, B.mark = function(c) {
      return Object.setPrototypeOf ? Object.setPrototypeOf(c, y) : (c.__proto__ = y, s(c, n, "GeneratorFunction")), c.prototype = Object.create(b), c;
    }, B.awrap = function(c) {
      return {
        __await: c
      };
    }, T(W.prototype), s(W.prototype, t, function() {
      return this;
    }), B.AsyncIterator = W, B.async = function(c, r, a, l, D) {
      D === void 0 && (D = Promise);
      var u = new W(w(c, r, a, l), D);
      return B.isGeneratorFunction(r) ? u : u.next().then(function(o) {
        return o.done ? o.value : u.next();
      });
    }, T(b), s(b, n, "Generator"), s(b, i, function() {
      return this;
      ...
      return a.reverse(), function D() {
        for (; a.length; ) {
          var u = a.pop();
          if (u in r)
            return D.value = u, D.done = !1, D;
        }
        return D.done = !0, D;
      };
    }, B.values = d, P.prototype = {
      constructor: P,
      reset: function(r) {
        if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(z), !r)
          for (var a in this)
            a.charAt(0) === "t" && Q.call(this, a) && !isNaN(+a.slice(1)) && (this[a] = void 0);
      },
      stop: function() {
        this.done = !0;
      ...
      dispatchException: function(r) {
        ...
        var a = this;
        function l(L, m) {
          return o.type = "throw", o.arg = r, a.next = L, m && (a.method = "next", a.arg = void 0), !!m;
        }
        for (var D = this.tryEntries.length - 1; D >= 0; --D) {
          var u = this.tryEntries[D], o = u.completion;
          if (u.tryLoc === "root")
            return l("end");
          if (u.tryLoc <= this.prev) {
            var G = Q.call(u, "catchLoc"), F = Q.call(u, "finallyLoc");
            if (G && F) {
              if (this.prev < u.catchLoc)
                return l(u.catchLoc, !0);
      ...
      abrupt: function(r, a) {
        ...
        u && (r === "break" || r === "continue") && u.tryLoc <= a && a <= u.finallyLoc && (u = null);
        var o = u ? u.completion : {};
        return o.type = r, o.arg = a, u ? (this.method = "next", this.next = u.finallyLoc, f) : this.complete(o);
      },
      complete: function(r, a) {
        if (r.type === "throw")
          throw r.arg;
        return r.type === "break" || r.type === "continue" ? this.next = r.arg : r.type === "return" ? (this.rval = this.arg = r.arg, this.method = "return", this.next = "end") : r.type === "normal" && a && (this.next = a), f;
      },
      finish: function(r) {
        for (var a = this.tryEntries.length - 1; a >= 0; --a) {
          var l = this.tryEntries[a];
          if (l.finallyLoc === r)
            return this.complete(l.completion, l.afterLoc), z(l), f;
        }
      },
      catch: function(r) {
        for (var a = this.tryEntries.length - 1; a >= 0; --a) {
...
var SA = dg.exports(), R = SA;
try {
  regeneratorRuntime = SA;
} catch {
  typeof globalThis == "object" ? globalThis.regeneratorRuntime = SA : Function("r", "regeneratorRuntime = r")(SA);
}
function hA(A) {
  return hA = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(g) {
    return typeof g;
  } : function(g) {
...
function _g(A, g) {
  ...
  if (I != null) {
    var B = [], C = !0, Q = !1, E, e;
    try {
      for (I = I.call(A); !(C = (E = I.next()).done) && (B.push(E.value), !(g && B.length === g)); C = !0)
        ;
    } catch (i) {
      Q = !0, e = i;
    } finally {
...
function sg(A, g) {
  ...
  for (var I = 0, B = new Array(g); I < g; I++)
    B[I] = A[I];
  return B;
}
function $g(A, g) {
...
function Ng(A, g) {
  return Pg(A) || _g(A, g) || $g(A, g) || AI();
}
const gI = (A, g) => A === g, rA = Symbol("solid-proxy"), YA = {
  equals: gI
};
let Fg = Yg;
const oA = {}, CA = 1, pA = 2, Rg = {
  owned: null,
  cleanups: null,
  context: null,
  owner: null
...
var q = null;
let yA = null, U = null, uA = null, j = null, V = null, Bg = 0;
function nA(A, g) {
  const I = U, B = q, C = A.length === 0 ? Rg : {
    owned: null,
    cleanups: null,
    context: null,
    owner: g || B
...
function Qg(A, g) {
  ...
  }, B = (C) => (typeof C == "function" && (C = C(I.pending !== oA ? I.pending : I.value)), Cg(I, C));
  return [vg.bind(I), B];
}
function AA(A, g, I) {
  const B = Eg(A, g, !1, CA);
...
function Mg(A, g, I) {
  Fg = CI;
  const B = Eg(A, g, !1, CA);
  B.user = !0, V ? V.push(B) : queueMicrotask(() => GA(B));
}
function Z(A, g, I) {
  I = I ? Object.assign({}, YA, I) : YA;
  const B = Eg(A, g, !0, 0);
  return B.pending = oA, B.observers = null, B.observerSlots = null, B.comparator = I.equals || void 0, GA(B), vg.bind(B);
}
function Sg(A) {
  if (uA)
    return A();
...
function EA(A) {
  let g, I = U;
  return U = null, g = A(), U = I, g;
}
function Jg(A) {
  Mg(() => EA(A));
}
function OA(A) {
  return q === null || (q.cleanups === null ? q.cleanups = [A] : q.cleanups.push(A)), A;
}
function Lg() {
  return U;
}
...
function vg() {
  ...
  if (this.sources && (this.state || A)) {
    const g = j;
    j = null, this.state === CA || A ? GA(this) : UA(this), j = g;
  }
  if (U) {
    const g = this.observers ? this.observers.length : 0;
    U.sources ? (U.sources.push(this), U.sourceSlots.push(g)) : (U.sources = [this], U.sourceSlots = [g]), this.observers ? (this.observers.push(U), this.observerSlots.push(U.sources.length - 1)) : (this.observers = [U], this.observerSlots = [U.sources.length - 1]);
  }
  return this.value;
}
function Cg(A, g, I) {
  if (uA)
    return A.pending === oA && uA.push(A), A.pending = g, g;
  if (A.comparator && A.comparator(A.value, g))
    return g;
  let B = !1;
  return A.value = g, A.observers && A.observers.length && eg(() => {
    for (let C = 0; C < A.observers.length; C += 1) {
      const Q = A.observers[C];
      B && yA.disposed.has(Q), (B && !Q.tState || !B && !Q.state) && (Q.pure ? j.push(Q) : V.push(Q), Q.observers && pg(Q)), B || (Q.state = CA);
    }
    if (j.length > 1e6)
      throw j = [], new Error();
  }, !1), g;
...
function BI(A, g, I) {
  ...
  (!A.updatedAt || A.updatedAt <= I) && (A.observers && A.observers.length ? Cg(A, B) : A.value = B, A.updatedAt = I);
}
function Eg(A, g, I, B = CA, C) {
  const Q = {
    fn: A,
    state: B,
    updatedAt: null,
  ...
  return q === null || q !== Rg && (q.owned ? q.owned.push(Q) : q.owned = [Q]), Q;
}
function lA(A) {
  const g = yA;
  if (A.state === 0 || g)
  ...
  if (A.state === pA || g)
    return UA(A);
  if (A.suspense && EA(A.suspense.inFallback))
    return A.suspense.effects.push(A);
  const I = [A];
  for (; (A = A.owner) && (!A.updatedAt || A.updatedAt < Bg); )
    (A.state || g) && I.push(A);
  for (let B = I.length - 1; B >= 0; B--)
    if (A = I[B], A.state === CA || g)
      GA(A);
    else if (A.state === pA || g) {
      const C = j;
      j = null, UA(A, I[0]), j = C;
    }
}
...
function UA(A, g) {
  ...
  for (let B = 0; B < A.sources.length; B += 1) {
    const C = A.sources[B];
    C.sources && (C.state === CA || I ? C !== g && lA(C) : (C.state === pA || I) && UA(C, g));
  }
}
function pg(A) {
  const g = yA;
  for (let I = 0; I < A.observers.length; I += 1) {
    ...
    (!B.state || g) && (B.state = pA, B.pure ? j.push(B) : V.push(B), B.observers && pg(B));
  }
}
function ig(A) {
  let g;
  if (A.sources)
    for (; A.sources.length; ) {
      const I = A.sources.pop(), B = A.sourceSlots.pop(), C = I.observers;
      if (C && C.length) {
        const Q = C.pop(), E = I.observerSlots.pop();
        B < C.length && (Q.sourceSlots[E] = B, C[B] = Q, I.observerSlots[B] = E);
      }
    }
  if (A.owned) {
...
function EI(A, g, I = {}) {
  let B = [], C = [], Q = [], E = 0, e = g.length > 1 ? [] : null;
  return OA(() => mA(Q)), () => {
    let i = A() || [], t, n;
    return EA(() => {
      let w = i.length, h, f, k, N, y, S, J, v, b;
      if (w === 0)
        E !== 0 && (mA(Q), Q = [], B = [], C = [], E = 0, e && (e = [])), I.fallback && (B = [VA], C[0] = nA((T) => (Q[0] = T, I.fallback())), E = 1);
      else if (E === 0) {
        for (C = new Array(w), n = 0; n < w; n++)
          B[n] = i[n], C[n] = nA(s);
        E = w;
      } else {
        for (k = new Array(w), N = new Array(w), e && (y = new Array(w)), S = 0, J = Math.min(E, w); S < J && B[S] === i[S]; S++)
          ;
        for (J = E - 1, v = w - 1; J >= S && v >= S && B[J] === i[v]; J--, v--)
          k[v] = C[J], N[v] = Q[J], e && (y[v] = e[J]);
        for (h = /* @__PURE__ */ new Map(), f = new Array(v + 1), n = v; n >= S; n--)
          b = i[n], t = h.get(b), f[n] = t === void 0 ? -1 : t, h.set(b, n);
        for (t = S; t <= J; t++)
          b = B[t], n = h.get(b), n !== void 0 && n !== -1 ? (k[n] = C[t], N[n] = Q[t], e && (y[n] = e[t]), n = f[n], h.set(b, n)) : Q[t]();
        for (n = S; n < w; n++)
          n in k ? (C[n] = k[n], Q[n] = N[n], e && (e[n] = y[n], e[n](n))) : C[n] = nA(s);
        C = C.slice(0, E = w), B = i.slice(0);
      }
      return C;
    });
    function s(w) {
...
function eI(A, g, I = {}) {
  ...
  return OA(() => mA(Q)), () => {
    ...
    return EA(() => {
      if (t.length === 0)
        return e !== 0 && (mA(Q), Q = [], B = [], C = [], e = 0, E = []), I.fallback && (B = [VA], C[0] = nA((s) => (Q[0] = s, I.fallback())), e = 1), C;
      for (B[0] === VA && (Q[0](), Q = [], B = [], C = [], e = 0), i = 0; i < t.length; i++)
        i < B.length && B[i] !== t[i] ? E[i](() => t[i]) : i >= B.length && (C[i] = nA(n));
      for (; i < B.length; i++)
        Q[i]();
      return e = E.length = Q.length = t.length, B = t.slice(0), C = C.slice(0, e);
    });
    function n(s) {
      Q[i] = s;
      const [w, h] = Qg(t[i]);
...
function iI(A) {
  ...
  return Z(EI(() => A.each, A.children, g || void 0));
}
function tI(A) {
  const g = "fallback" in A && {
    fallback: () => A.fallback
...
function ag(A) {
  let g = !1;
  const I = Z(() => A.when, void 0, {
    equals: (B, C) => g ? B === C : !B == !C
  });
  return Z(() => {
    const B = I();
    if (B) {
      const C = A.children;
      return (g = typeof C == "function" && C.length > 0) ? EA(() => C(B)) : C;
    }
    return A.fallback;
  });
}
function mg(A) {
  ...
  const I = II(() => A.children), B = Z(() => {
    ...
    equals: (C, Q) => C[0] === Q[0] && (g ? C[1] === Q[1] : !C[1] == !Q[1]) && C[2] === Q[2]
  });
  return Z(() => {
    const [C, Q, E] = B();
    if (C < 0)
      return A.fallback;
    const e = E.children;
    return (g = typeof e == "function" && e.length > 0) ? EA(() => e(Q)) : e;
  });
}
function bA(A) {
  return A;
...
function nI(A, g) {
  return Z(A, void 0, g ? void 0 : {
    equals: g
  });
}
function rI(A, g, I) {
  let B = I.length, C = g.length, Q = B, E = 0, e = 0, i = g[C - 1].nextSibling, t = null;
  for (; E < C || e < Q; ) {
    if (g[E] === I[e]) {
      E++, e++;
      continue;
    ...
    for (; g[C - 1] === I[Q - 1]; )
      C--, Q--;
    if (C === E) {
      const n = Q < B ? e ? I[e - 1].nextSibling : I[Q - e] : i;
      for (; e < Q; )
        A.insertBefore(I[e++], n);
    } else if (Q === e)
      for (; E < C; )
        (!t || !t.has(g[E])) && g[E].remove(), E++;
    else if (g[E] === I[Q - 1] && I[e] === g[C - 1]) {
      const n = g[--C].nextSibling;
      A.insertBefore(I[e++], g[E++].nextSibling), A.insertBefore(I[--Q], n), g[C] = I[Q];
    } else {
      if (!t) {
        t = /* @__PURE__ */ new Map();
        let s = e;
      ...
      if (n != null)
        if (e < n && n < Q) {
          let s = E, w = 1, h;
          for (; ++s < C && s < Q && !((h = t.get(g[s])) == null || h !== n + w); )
            w++;
          if (w > n - e) {
            const f = g[E];
            for (; e < n; )
              A.insertBefore(I[e++], f);
          } else
            A.replaceChild(I[e++], g[E++]);
        } else
          E++;
      else
        g[E++].remove();
...
function oI(A, g, I) {
  let B;
  return nA((C) => {
    B = C, g === document ? A() : x(g, A(), g.firstChild ? null : void 0, I);
  }), () => {
    B(), g.textContent = "";
  };
}
function O(A, g, I) {
  ...
  B.innerHTML = A;
  let C = B.content.firstChild;
  return I && (C = C.firstChild), C;
}
function tg(A, g = window.document) {
  const I = g[cg] || (g[cg] = /* @__PURE__ */ new Set());
  for (let B = 0, C = A.length; B < C; B++) {
    const Q = A[B];
    I.has(Q) || (I.add(Q), g.addEventListener(Q, sI));
  }
}
function zA(A, g, I, B) {
  B ? Array.isArray(I) ? (A[`$$${g}`] = I[0], A[`$$${g}Data`] = I[1]) : A[`$$${g}`] = I : Array.isArray(I) ? A.addEventListener(g, (C) => I[0](I[1], C)) : A.addEventListener(g, I);
}
function WA(A, g, I = {}) {
  const B = A.style;
  ...
  let C, Q;
  for (Q in I)
    g[Q] == null && B.removeProperty(Q), delete I[Q];
  for (Q in g)
    C = g[Q], C !== I[Q] && (B.setProperty(Q, C), I[Q] = C);
  return I;
}
function x(A, g, I, B) {
...
function sI(A) {
  ...
  for (A.target !== I && Object.defineProperty(A, "target", {
    ...
    if (B && !I.disabled) {
      const C = I[`${g}Data`];
      if (C !== void 0 ? B(C, A) : B(A), A.cancelBubble)
        return;
    }
    I = I.host && I.host !== I && I.host instanceof Node ? I.host : I.parentNode;
  }
}
function KA(A, g, I, B, C) {
  for (; typeof I == "function"; )
    I = I();
  if (g === I)
    return I;
  const Q = typeof g, E = B !== void 0;
  if (A = E && I[0] && I[0].parentNode || A, Q === "string" || Q === "number")
    if (Q === "number" && (g = g.toString()), E) {
      let e = I[0];
      e && e.nodeType === 3 ? e.data = g : e = document.createTextNode(g), I = eA(A, I, B, e);
    } else
      I !== "" && typeof I == "string" ? I = A.firstChild.data = g : I = A.textContent = g;
  else if (g == null || Q === "boolean")
    I = eA(A, I, B);
  else {
    if (Q === "function")
      return AA(() => {
    ...
    if (Array.isArray(g)) {
      const e = [];
      if (PA(e, g, C))
        return AA(() => I = KA(A, e, I, B, !0)), () => I;
      if (e.length === 0) {
        if (I = eA(A, I, B), E)
          return I;
      } else
        Array.isArray(I) ? I.length === 0 ? ug(A, e, B) : rI(A, I, e) : (I && eA(A), ug(A, e));
      I = e;
...
function PA(A, g, I) {
  let B = !1;
  for (let C = 0, Q = g.length; C < Q; C++) {
    let E = g[C], e;
    if (E instanceof Node)
      A.push(E);
    else if (!(E == null || E === !0 || E === !1))
      if (Array.isArray(E))
        B = PA(A, E) || B;
      else if ((e = typeof E) == "string")
        A.push(document.createTextNode(E));
      else if (e === "function")
        if (I) {
          for (; typeof E == "function"; )
            E = E();
          B = PA(A, Array.isArray(E) ? E : [E]) || B;
        } else
          A.push(E), B = !0;
      else
        A.push(document.createTextNode(E.toString()));
  }
  return B;
}
function ug(A, g, I) {
...
function eA(A, g, I, B) {
  ...
  const C = B || document.createTextNode("");
  if (g.length) {
    let Q = !1;
    for (let E = g.length - 1; E >= 0; E--) {
      const e = g[E];
      if (C !== e) {
        const i = e.parentNode === A;
        !Q && !E ? i ? A.replaceChild(C, e) : A.insertBefore(C, I) : i && e.remove();
      } else
        Q = !0;
    }
  } else
...
function gA(A) {
  wA === $.length && $.push($.length + 1);
  var g = wA;
  return wA = $[g], $[g] = A, g;
}
var bg = new TextDecoder("utf-8", {
  ignoreBOM: !0,
  fatal: !0
});
bg.decode();
var kA = null;
function JA() {
  return (kA === null || kA.buffer !== Y.memory.buffer) && (kA = new Uint8Array(Y.memory.buffer)), kA;
}
function LA(A, g) {
  return bg.decode(JA().subarray(A, A + g));
}
function _A(A) {
  var g = hA(A);
  ...
  if (g == "symbol") {
    var I = A.description;
    return I == null ? "Symbol" : "Symbol(".concat(I, ")");
  }
  if (g == "function") {
    var B = A.name;
    return typeof B == "string" && B.length > 0 ? "Function(".concat(B, ")") : "Function";
  }
  if (Array.isArray(A)) {
    var C = A.length, Q = "[";
    C > 0 && (Q += _A(A[0]));
  ...
  var e = /\[object ([^\]]+)\]/.exec(toString.call(A)), i;
  if (e.length > 1)
    i = e[1];
  else
...
var HA = 0, vA = new TextEncoder("utf-8"), cI = typeof vA.encodeInto == "function" ? function(A, g) {
  return vA.encodeInto(A, g);
} : function(A, g) {
  var I = vA.encode(A);
  return g.set(I), {
    read: A.length,
...
function Kg(A, g, I) {
  if (I === void 0) {
    var B = vA.encode(A), C = g(B.length);
    return JA().subarray(C, C + B.length).set(B), HA = B.length, C;
  }
  for (var Q = A.length, E = g(Q), e = JA(), i = 0; i < Q; i++) {
  ...
  if (i !== Q) {
    i !== 0 && (A = A.slice(i)), E = I(E, Q, Q = i + A.length * 3);
    var n = JA().subarray(E + i, E + Q), s = cI(A, n);
    i += s.written;
  }
  return HA = i, E;
}
var NA = null;
function tA() {
  return (NA === null || NA.buffer !== Y.memory.buffer) && (NA = new Int32Array(Y.memory.buffer)), NA;
}
function uI(A, g) {
  var I = Y.create(A, g);
  return Hg.__wrap(I);
...
var FA = null;
function lI() {
  return (FA === null || FA.buffer !== Y.memory.buffer) && (FA = new Uint32Array(Y.memory.buffer)), FA;
}
function wI(A, g) {
  return lI().subarray(A / 4, A / 4 + g);
}
var $A = new Uint32Array(2), fI = new BigUint64Array($A.buffer), Hg = /* @__PURE__ */ function() {
  function A() {
    TA(this, A);
  }
  return ZA(A, [{
    ...
    value: function() {
      ...
      Y.__wbg_vtwrapper_free(I);
    }
  }, {
    key: "feed",
    value: function(I) {
      try {
        var B = Y.__wbindgen_add_to_stack_pointer(-16), C = Kg(I, Y.__wbindgen_malloc, Y.__wbindgen_realloc), Q = HA;
        Y.vtwrapper_feed(B, this.ptr, C, Q);
        var E = tA()[B / 4 + 0], e = tA()[B / 4 + 1], i = wI(E, e).slice();
        return Y.__wbindgen_free(E, e * 4), i;
      } finally {
    ...
    value: function() {
      try {
        var I = Y.__wbindgen_add_to_stack_pointer(-16);
        Y.vtwrapper_inspect(I, this.ptr);
        var B = tA()[I / 4 + 0], C = tA()[I / 4 + 1];
        return LA(B, C);
      } finally {
        Y.__wbindgen_add_to_stack_pointer(16), Y.__wbindgen_free(B, C);
      }
    }
  }, {
    key: "get_line",
    value: function(I) {
      var B = Y.vtwrapper_get_line(this.ptr, I);
      return fA(B);
    }
  }, {
    key: "get_cursor",
    value: function() {
      var I = Y.vtwrapper_get_cursor(this.ptr);
      return fA(I);
    }
  }], [{
    key: "__wrap",
...
function Ag() {
  return Ag = K(/* @__PURE__ */ R.mark(function A(g, I) {
    var B, C;
      ...
      for (; ; )
        switch (E.prev = E.next) {
          case 0:
            ...
            return E.prev = 2, E.next = 5, WebAssembly.instantiateStreaming(g, I);
          case 5:
            return E.abrupt("return", E.sent);
          case 8:
            if (E.prev = 8, E.t0 = E.catch(2), g.headers.get("Content-Type") == "application/wasm") {
              E.next = 14;
              break;
            }
          ...
          case 14:
            throw E.t0;
          case 15:
            return E.next = 17, g.arrayBuffer();
          case 17:
            return B = E.sent, E.next = 20, WebAssembly.instantiate(B, I);
          case 20:
            return E.abrupt("return", E.sent);
          case 23:
            return E.next = 25, WebAssembly.instantiate(g, I);
          case 25:
            if (C = E.sent, !(C instanceof WebAssembly.Instance)) {
              E.next = 30;
              break;
            }
...
function gg() {
  return gg = K(/* @__PURE__ */ R.mark(function A(g) {
    var I, B, C, Q;
    return R.wrap(function(e) {
      for (; ; )
        switch (e.prev = e.next) {
          case 0:
            return typeof g > "u" && (g = new URL("index_bg.wasm", "")), I = {}, I.wbg = {}, I.wbg.__wbindgen_object_drop_ref = function(i) {
              fA(i);
            }, I.wbg.__wbindgen_number_new = function(i) {
              var t = i;
              return gA(t);
            }, I.wbg.__wbg_BigInt_1b7cf17b993da2bd = function(i, t) {
              $A[0] = i, $A[1] = t;
              var n = fI[0], s = BigInt(n);
              return gA(s);
            }, I.wbg.__wbindgen_string_new = function(i, t) {
              var n = LA(i, t);
              return gA(n);
            }, I.wbg.__wbg_set_fbb49ad265f9dee8 = function(i, t, n) {
              _(i)[fA(t)] = fA(n);
              ...
              var i = new Object();
              return gA(i);
            }, I.wbg.__wbindgen_is_string = function(i) {
              var t = typeof _(i) == "string";
              return t;
            }, I.wbg.__wbg_push_284486ca27c6aa8b = function(i, t) {
              var n = _(i).push(_(t));
              return n;
            }, I.wbg.__wbg_new_342a24ca698edd87 = function(i, t) {
              var n = new Error(LA(i, t));
              return gA(n);
            }, I.wbg.__wbg_set_a46091b120cc63e9 = function(i, t, n) {
              var s = _(i).set(_(t), _(n));
              return gA(s);
            }, I.wbg.__wbindgen_debug_string = function(i, t) {
              var n = _A(_(t)), s = Kg(n, Y.__wbindgen_malloc, Y.__wbindgen_realloc), w = HA;
              tA()[i / 4 + 1] = w, tA()[i / 4 + 0] = s;
            }, I.wbg.__wbindgen_throw = function(i, t) {
              throw new Error(LA(i, t));
            }, (typeof g == "string" || typeof Request == "function" && g instanceof Request || typeof URL == "function" && g instanceof URL) && (g = fetch(g)), e.t0 = hI, e.next = 21, g;
          case 21:
            return e.t1 = e.sent, e.t2 = I, e.next = 25, (0, e.t0)(e.t1, e.t2);
          case 25:
            return B = e.sent, C = B.instance, Q = B.module, Y = C.exports, ng.__wbindgen_wasm_module = Q, e.abrupt("return", Y);
          case 31:
          case "end":
            return e.stop();
        }
...
var FI = kI(), RI = /* @__PURE__ */ function() {
  function A(g, I) {
    var B;
    TA(this, A), this.state = "initial", this.driver = null, this.driverFn = g, this.changedLines = /* @__PURE__ */ new Set(), this.cursor = void 0, this.duration = null, this.cols = I.cols, this.rows = I.rows, this.startTime = null, this.speed = (B = I.speed) !== null && B !== void 0 ? B : 1, this.loop = I.loop, this.idleTimeLimit = I.idleTimeLimit, this.preload = I.preload, this.startAt = lg(I.startAt), this.poster = I.poster, this.eventHandlers = /* @__PURE__ */ new Map([["starting", []], ["waiting", []], ["reset", []], ["play", []], ["pause", []], ["terminalUpdate", []], ["seeked", []], ["ended", []]]);
  }
  return ZA(A, [{
    key: "addEventListener",
    value: function(I, B) {
      this.eventHandlers.get(I).push(B);
    }
  }, {
    key: "dispatchEvent",
    value: function(I) {
      var B = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, C = wg(this.eventHandlers.get(I)), Q;
      try {
        for (C.s(); !(Q = C.n()).done; ) {
          var E = Q.value;
          E(B);
    ...
    key: "init",
    value: function() {
      var g = K(/* @__PURE__ */ R.mark(function B() {
        var C = this, Q, E, e, i, t, n, s, w, h, f, k;
        return R.wrap(function(y) {
          for (; ; )
            switch (y.prev = y.next) {
              case 0:
                return e = 0, i = this.feed.bind(this), t = this.now.bind(this), n = function(J, v) {
                  return window.setTimeout(J, v / C.speed);
                }, s = function(J, v) {
                  return window.setInterval(J, v / C.speed);
                }, w = function(J, v) {
                  C.resetVt(J, v);
                }, h = function() {
                  e++, C.loop === !0 || typeof C.loop == "number" && e < C.loop ? C.restart() : (C.state = "finished", C.dispatchEvent("ended"));
                }, f = !1, k = function(J) {
                  J && !f ? (f = !0, C.dispatchEvent("waiting")) : !J && f && (f = !1, C.dispatchEvent("play"));
                }, y.next = 11, FI;
              case 11:
                return this.wasm = y.sent, this.driver = this.driverFn({
                  feed: i,
                  now: t,
                  setTimeout: n,
                  setInterval: s,
                  ...
                  start: this.driver
                }), this.duration = this.driver.duration, this.cols = (Q = this.cols) !== null && Q !== void 0 ? Q : this.driver.cols, this.rows = (E = this.rows) !== null && E !== void 0 ? E : this.driver.rows, this.preload && this.initializeDriver(), y.t0 = !!this.driver.pauseOrResume, y.t1 = !!this.driver.seek, y.next = 22, this.renderPoster();
              case 22:
                return y.t2 = y.sent, y.abrupt("return", {
                  isPausable: y.t0,
                  isSeekable: y.t1,
                  poster: y.t2
                });
          ...
          for (; ; )
            switch (Q.prev = Q.next) {
              case 0:
                ...
                return Q.next = 3, this.start();
              case 3:
                Q.next = 6;
                break;
              case 5:
                this.state == "paused" ? this.resume() : this.state == "finished" && this.restart();
              case 6:
              case "end":
                return Q.stop();
            }
    ...
    key: "seek",
    value: function() {
      var g = K(/* @__PURE__ */ R.mark(function B(C) {
        return R.wrap(function(E) {
          for (; ; )
            switch (E.prev = E.next) {
              case 0:
                return E.next = 2, this.doSeek(C);
              case 2:
    ...
    value: function() {
      if (this.changedLines.size > 0) {
        var I = /* @__PURE__ */ new Map(), B = wg(this.changedLines), C;
        try {
          for (B.s(); !(C = B.n()).done; ) {
            var Q = C.value;
            I.set(Q, {
        ...
        return this.changedLines.clear(), I;
      }
    }
  }, {
    key: "getCursor",
    value: function() {
      if (this.cursor === void 0 && this.vt) {
        var I;
        this.cursor = (I = this.vt.get_cursor()) !== null && I !== void 0 ? I : !1;
      }
      return this.cursor;
    }
  }, {
    ...
    value: function() {
      ...
      if (this.startTime)
        return (this.now() - this.startTime) / 1e3;
    }
  }, {
        ...
        return R.wrap(function(i) {
          for (; ; )
            switch (i.prev = i.next) {
              case 0:
                return this.dispatchEvent("starting"), Q = setTimeout(function() {
                  C.dispatchEvent("waiting");
                }, 2e3), i.next = 4, this.initializeDriver();
              case 4:
                return this.dispatchEvent("terminalUpdate"), i.next = 7, this.driver.start();
              case 7:
                E = i.sent, clearTimeout(Q), typeof E == "function" && (this.driver.stop = E), this.startTime = this.now(), this.state = "playing", this.dispatchEvent("play");
              case 13:
              case "end":
                return i.stop();
            }
          ...
          for (; ; )
            switch (E.prev = E.next) {
              case 0:
                ...
                return E.next = 3, this.initializeDriver();
              case 3:
                return this.state != "playing" && (this.state = "paused"), this.driver.seek(C), E.abrupt("return", !0);
              case 8:
    ...
    key: "feed",
    value: function(I) {
      var B = this, C = this.vt.feed(I);
      C.forEach(function(Q) {
        return B.changedLines.add(Q);
      }), this.cursor = void 0, this.dispatchEvent("terminalUpdate");
    }
  }, {
    key: "now",
    value: function() {
          ...
          for (; ; )
            switch (t.prev = t.next) {
              case 0:
                ...
                return t.next = 3, this.driver.init();
              case 3:
                e = t.sent, this.duration = (C = this.duration) !== null && C !== void 0 ? C : e.duration, this.cols = (Q = this.cols) !== null && Q !== void 0 ? Q : e.cols, this.rows = (E = this.rows) !== null && E !== void 0 ? E : e.rows;
              case 7:
                this.ensureVt();
              case 8:
              case "end":
    ...
    key: "ensureVt",
    value: function() {
      var I, B, C = (I = this.cols) !== null && I !== void 0 ? I : 80, Q = (B = this.rows) !== null && B !== void 0 ? B : 24;
      this.vt !== void 0 && this.vt.cols === C && this.vt.rows === Q || this.initializeVt(C, Q);
    }
  }, {
    key: "resetVt",
    value: function(I, B) {
      this.cols = I, this.rows = B, this.initializeVt(I, B);
    }
  }, {
    key: "initializeVt",
    value: function(I, B) {
      this.vt = this.wasm.create(I, B), this.vt.cols = I, this.vt.rows = B, this.changedLines.clear();
      for (var C = 0; C < B; C++)
        this.changedLines.add(C);
        ...
        return R.wrap(function(n) {
          for (; ; )
            switch (n.prev = n.next) {
              ...
              case 2:
                if (this.ensureVt(), Q = [], this.poster.substring(0, 16) != "data:text/plain,") {
                  n.next = 8;
                  break;
                }
                Q = [this.poster.substring(16)], n.next = 12;
                break;
              case 8:
                ...
                return n.next = 11, this.initializeDriver();
              case 11:
                Q = this.driver.getPoster(this.parseNptPoster(this.poster));
              case 12:
                for (Q.forEach(function(s) {
                  return C.vt.feed(s);
                }), E = this.getCursor(), e = [], i = 0; i < this.vt.rows; i++)
                  e.push({
                    id: i,
                    segments: this.vt.get_line(i)
                  }), this.changedLines.add(i);
                return this.vt.feed("\x1Bc"), this.cursor = void 0, n.abrupt("return", {
                  cursor: E,
                  lines: e
                });
              case 19:
    ...
    key: "parseNptPoster",
    value: function(I) {
      return lg(I.substring(4));
    }
  }]), A;
}();
const qg = Symbol("store-raw"), qA = Symbol("store-node"), MI = Symbol("store-name");
function jg(A, g) {
  let I = A[rA];
  if (!I) {
    Object.defineProperty(A, rA, {
      value: I = new Proxy(A, LI)
    });
    const B = Object.keys(A), C = Object.getOwnPropertyDescriptors(A);
    for (let Q = 0, E = B.length; Q < E; Q++) {
      const e = B[Q];
      if (C[e].get) {
        const i = C[e].get.bind(I);
...
function IA(A) {
  return A != null && typeof A == "object" && (A[rA] || !A.__proto__ || A.__proto__ === Object.prototype || Array.isArray(A));
}
function DA(A, g = /* @__PURE__ */ new Set()) {
  let I, B, C, Q;
  if (I = A != null && A[qg])
    return I;
  if (!IA(A) || g.has(A))
  ...
  if (Array.isArray(A)) {
    ...
    for (let E = 0, e = A.length; E < e; E++)
      C = A[E], (B = DA(C, g)) !== C && (A[E] = B);
  } else {
    Object.isFrozen(A) ? A = Object.assign({}, A) : g.add(A);
    const E = Object.keys(A), e = Object.getOwnPropertyDescriptors(A);
    for (let i = 0, t = E.length; i < t; i++)
      Q = E[i], !e[Q].get && (C = A[Q], (B = DA(C, g)) !== C && (A[Q] = B));
  }
  return A;
}
function jA(A) {
...
function SI(A, g) {
  ...
  return !I || I.get || !I.configurable || g === rA || g === qA || g === MI || (delete I.value, delete I.writable, I.get = () => A[rA][g]), I;
}
function JI(A) {
  if (Lg()) {
    const g = jA(A);
...
const LI = {
  get(A, g, I) {
    ...
    if (g === qA || g === "__proto__")
      return B;
    const C = IA(B);
    if (Lg() && (typeof B != "function" || A.hasOwnProperty(g))) {
      let Q, E;
      C && (Q = jA(B)) && (E = Q._ || (Q._ = Ig()), E()), Q = jA(A), E = Q[g] || (Q[g] = Ig()), E();
    }
    return C ? jg(B) : B;
  },
  set() {
...
function X(A, g, I) {
  if (A[g] === I)
    return;
  const B = Array.isArray(A), C = A.length, Q = I === void 0, E = B || Q === g in A;
  Q ? delete A[g] : A[g] = I;
  let e = jA(A), i;
  (i = e[g]) && i.$(), B && A.length !== C && (i = e.length) && i.$(), E && (i = e._) && i.$();
}
function vI(A, g) {
...
function aA(A, g, I = []) {
  ...
  if (g.length > 1) {
    B = g.shift();
    const E = typeof B, e = Array.isArray(A);
    if (Array.isArray(B)) {
      for (let i = 0; i < B.length; i++)
        aA(A, [B[i]].concat(g), I);
      return;
    } else if (e && E === "function") {
      for (let i = 0; i < A.length; i++)
        B(A[i], i) && aA(A, [i].concat(g), I);
      return;
    } else if (e && E === "object") {
      const {
        from: i = 0,
  ...
  let Q = g[0];
  typeof Q == "function" && (Q = Q(C, I), Q === C) || B === void 0 && Q == null || (Q = DA(Q), B === void 0 || IA(C) && IA(Q) && !Array.isArray(Q) ? vI(C, Q) : X(A, B, Q));
}
function xg(A, g) {
  const I = DA(A || {}), B = jg(I);
  function C(...Q) {
...
function iA(A, g, I, B, C) {
  const Q = g[I];
  if (A === Q)
    return;
  if (!IA(A) || !IA(Q) || C && A[C] !== Q[C]) {
    A !== Q && X(g, I, A);
    return;
  }
  if (Array.isArray(A)) {
    if (A.length && Q.length && (!B || C && A[0][C] != null)) {
      let i, t, n, s, w, h, f, k;
      for (n = 0, s = Math.min(Q.length, A.length); n < s && (Q[n] === A[n] || C && Q[n][C] === A[n][C]); n++)
        iA(A[n], Q, n, B, C);
      const N = new Array(A.length), y = /* @__PURE__ */ new Map();
      for (s = Q.length - 1, w = A.length - 1; s >= n && w >= n && (Q[s] === A[w] || C && Q[s][C] === A[w][C]); s--, w--)
        N[w] = Q[s];
      if (n > w || n > s) {
        for (t = n; t <= w; t++)
          X(Q, t, A[t]);
        for (; t < A.length; t++)
          X(Q, t, N[t]), iA(A[t], Q, t, B, C);
        Q.length > A.length && X(Q, "length", A.length);
        return;
      }
      for (f = new Array(w + 1), t = w; t >= n; t--)
        h = A[t], k = C ? h[C] : h, i = y.get(k), f[t] = i === void 0 ? -1 : i, y.set(k, t);
      for (i = n; i <= s; i++)
        h = Q[i], k = C ? h[C] : h, t = y.get(k), t !== void 0 && t !== -1 && (N[t] = Q[i], t = f[t], y.set(k, t));
      for (t = n; t < A.length; t++)
        t in N ? (X(Q, t, N[t]), iA(A[t], Q, t, B, C)) : X(Q, t, A[t]);
    } else
...
function hg(A, g = {}) {
  ...
  return (Q) => !IA(Q) || !IA(C) ? C : (iA(C, {
    state: Q
  }, "state", I, B), Q);
}
const YI = O("<span></span>");
var pI = function(A) {
  return function() {
    var g = YI.cloneNode(!0);
    return x(g, function() {
      return A.text;
    }), AA(function(I) {
      var B = UI(A.attrs, A.extraClass), C = mI(A.attrs);
      return B !== I._v$ && (g.className = I._v$ = B), I._v$2 = WA(g, C, I._v$2), I;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), g;
...
function UI(A, g) {
  var I = A.get("inverse") ? A.has("bg") ? A.get("bg") : "bg" : A.get("fg"), B = A.get("inverse") ? A.has("fg") ? A.get("fg") : "fg" : A.get("bg"), C = Dg(I, A.get("bold"), "fg-"), Q = Dg(B, A.get("blink"), "bg-"), E = g != null ? g : "";
  return C && (E += " " + C), Q && (E += " " + Q), A.has("bold") && (E += " bright"), A.has("italic") && (E += " italic"), A.has("underline") && (E += " underline"), A.has("blink") && (E += " blink"), E;
}
function Dg(A, g, I) {
  if (typeof A == "number")
    return g && A < 8 && (A += 8), "".concat(I).concat(A);
  if (A == "fg" || A == "bg")
    return "".concat(I).concat(A);
}
function mI(A) {
  var g = A.get("inverse") ? A.get("bg") : A.get("fg"), I = A.get("inverse") ? A.get("fg") : A.get("bg"), B = {};
  return typeof g == "string" && (B.color = g), typeof I == "string" && (B["background-color"] = I), B;
}
const bI = O('<span class="line"></span>');
var KI = function(A) {
  var g = function() {
    if (typeof A.cursor == "number") {
      for (var B = [], C = 0, Q = 0; Q < A.segments.length && C + A.segments[Q][0].length - 1 < A.cursor; ) {
        var E = A.segments[Q];
        B.push(E), C += E[0].length, Q++;
      }
      if (Q < A.segments.length) {
        var e = A.segments[Q], i = e[1], t = new Map(i);
        t.set("inverse", !t.get("inverse"));
        var n = A.cursor - C;
        for (n > 0 && B.push([e[0].substring(0, n), e[1]]), B.push([e[0][n], i, " cursor-a"]), B.push([e[0][n], t, " cursor-b"]), n < e[0].length - 1 && B.push([e[0].substring(n + 1), e[1]]), Q++; Q < A.segments.length; ) {
          var s = A.segments[Q];
          B.push(s), Q++;
        }
      }
  ...
  return function() {
    ...
    return x(I, H(tI, {
      ...
      return I.style.setProperty("height", A.height);
    }), I;
  }();
};
const HI = O('<pre class="asciinema-terminal"></pre>');
var Tg = function(A) {
  var g = function() {
    var E;
    return (E = A.lineHeight) !== null && E !== void 0 ? E : 1.3333333333;
  }, I = Z(function() {
    return {
      width: "".concat(A.cols, "ch"),
      height: "".concat(g() * A.rows, "em"),
      "font-size": "".concat((A.scale || 1) * 100, "%"),
      "font-family": A.fontFamily,
      "line-height": "".concat(g(), "em")
    };
  }), B = function() {
    var E;
    return (E = A.cursor) === null || E === void 0 ? void 0 : E[0];
  }, C = function() {
    var E;
    return (E = A.cursor) === null || E === void 0 ? void 0 : E[1];
  };
  return function() {
    var Q = HI.cloneNode(!0), E = A.ref;
    return typeof E == "function" ? E(Q) : A.ref = Q, x(Q, H(iI, {
      get each() {
        return A.lines;
      },
      ...
      var i = A.blink || A.cursorHold, t = A.blink, n = I();
      return i !== e._v$ && Q.classList.toggle("cursor", e._v$ = i), t !== e._v$2 && Q.classList.toggle("blink", e._v$2 = t), e._v$3 = WA(Q, n, e._v$3), e;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0
...
const qI = O('<svg version="1.1" viewBox="0 0 12 12" class="icon"><path d="M1,0 L4,0 L4,12 L1,12 Z"></path><path d="M8,0 L11,0 L11,12 L8,12 Z"></path></svg>'), jI = O('<svg version="1.1" viewBox="0 0 12 12" class="icon"><path d="M1,0 L11,6 L1,12 Z"></path></svg>'), xI = O('<span class="playback-button"></span>'), TI = O('<span class="progressbar"><span class="bar"><span class="gutter"><span></span></span></span></span>'), ZI = O('<div class="control-bar"><span class="timer"><span class="time-elapsed"></span><span class="time-remaining"></span></span><span class="fullscreen-button" title="Toggle fullscreen mode"><svg version="1.1" viewBox="0 0 12 12" class="icon"><path d="M12,0 L7,0 L9,2 L7,4 L8,5 L10,3 L12,5 Z"></path><path d="M0,12 L0,7 L2,9 L4,7 L5,8 L3,10 L5,12 Z"></path></svg><svg version="1.1" viewBox="0 0 12 12" class="icon"><path d="M7,5 L7,0 L9,2 L11,0 L12,1 L10,3 L12,5 Z"></path><path d="M5,7 L0,7 L2,9 L0,11 L1,12 L3,10 L5,12 Z"></path></svg></span></div>');
function yg(A) {
  A = Math.floor(A);
  var g = Math.floor(A / 60), I = A % 60, B = "";
  return g < 10 && (B += "0"), B += "".concat(g, ":"), I < 10 && (B += "0"), B += "".concat(I), B;
}
var OI = function(A) {
  var g = function(e) {
    return function(i) {
    ...
    return typeof A.currentTime == "number" ? yg(A.currentTime) : "--:--";
  }, B = function() {
    return typeof A.remainingTime == "number" ? "-" + yg(A.remainingTime) : I();
  }, C = function() {
    return {
      width: "100%",
    ...
    if (!(e.altKey || e.shiftKey || e.metaKey || e.ctrlKey)) {
      var i = e.currentTarget.offsetWidth, t = e.currentTarget.getBoundingClientRect(), n = e.clientX - t.left, s = n / i;
      return A.onSeekClick("".concat(s * 100, "%"));
    }
  };
  return function() {
    var E = ZI.cloneNode(!0), e = E.firstChild, i = e.firstChild, t = i.nextSibling, n = e.nextSibling;
    return x(E, H(ag, {
      get when() {
        return A.isPausable;
      },
      get children() {
        var s = xI.cloneNode(!0);
        return zA(s, "click", g(A.onPlayClick), !0), x(s, H(mg, {
          get children() {
            return [H(bA, {
              get when() {
                return A.isPlaying;
              ...
              get children() {
                return jI.cloneNode(!0);
              }
            })];
          }
        })), s;
      }
    }), e), x(i, I), x(t, B), zA(n, "click", g(A.onFullscreenClick), !0), x(E, H(ag, {
      get when() {
        return typeof A.progress == "number" || A.isSeekable;
      },
      get children() {
        var s = TI.cloneNode(!0), w = s.firstChild, h = w.firstChild, f = h.firstChild;
        return w.$$mousedown = Q, AA(function(k) {
          return WA(f, C(), k);
        }), s;
      }
    }), null), AA(function() {
      return E.classList.toggle("seekable", A.isSeekable);
    }), E;
  }();
};
tg(["click", "mousedown"]);
const WI = O('<div class="loading"></div>');
var XI = function(A) {
  for (var g = ["\u2593", "\u2592", "\u2591", "\u2592"], I, B = 1, C = "", Q = 0; Q < A.cols - 1; Q++)
    C = C.concat(" ");
  var E = [C, /* @__PURE__ */ new Map()], e = /* @__PURE__ */ new Map([["inverse", !0]]), i = {
    segments: [E, [g[0], e]]
  }, t = xg({
    lines: [i]
  }), n = Ng(t, 2), s = n[0], w = n[1];
  return Jg(function() {
    I = setInterval(function() {
      var h = g[B % g.length], f = {
        segments: [E, [h, e]]
      };
      w("lines", 0, f), B++;
    }, 250);
...
var zI = function(A) {
  ...
  return function() {
    var I = VI.cloneNode(!0);
    return zA(I, "click", g(A.onClick), !0), I;
  }();
};
tg(["click"]);
const PI = O('<div class="asciinema-player-wrapper" tabindex="-1"><div></div></div>');
var _I = function(A) {
  var g = A.core, I = A.autoPlay, B = xg({
    coreState: "initial",
    cols: A.cols,
    rows: A.rows,
    lines: [],
    ...
    blink: !0,
    cursorHold: !1
  }), C = Ng(B, 2), Q = C[0], E = C[1], e = function() {
    return Q.cols || 80;
  }, i = function() {
    return Q.rows || 24;
  }, t, n, s, w, h, f, k, N;
  g.addEventListener("starting", function() {
    E("showStartOverlay", !1);
  }), g.addEventListener("waiting", function() {
    E("coreState", "waiting");
  }), g.addEventListener("reset", function(u) {
    var o = u.cols, G = u.rows;
    G < Q.rows && E("lines", Q.lines.slice(0, G)), E({
      cols: o,
      rows: G
    });
    ...
    E("coreState", "paused");
  }), g.addEventListener("terminalUpdate", function() {
    t === void 0 && (t = requestAnimationFrame(J));
  });
  var y = function() {
    E({
      charW: k.clientWidth / e(),
      charH: k.clientHeight / i(),
      bordersW: k.offsetWidth - k.clientWidth,
      bordersH: k.offsetHeight - k.clientHeight,
      containerW: h.offsetWidth,
      containerH: h.offsetHeight
    });
  }, S = function() {
    N = new ResizeObserver(function(o) {
      E({
        containerW: h.offsetWidth,
        containerH: h.offsetHeight
  ...
  Jg(/* @__PURE__ */ K(/* @__PURE__ */ R.mark(function u() {
    var o, G, F, L;
    return R.wrap(function(p) {
      for (; ; )
        switch (p.prev = p.next) {
          case 0:
            return console.debug("player mounted"), y(), S(), p.next = 5, g.init();
          case 5:
            o = p.sent, G = o.isPausable, F = o.isSeekable, L = o.poster, E({
              isPausable: G,
              isSeekable: F
            }), L !== void 0 && !I && E({
              lines: L.lines,
    ...
    g.stop(), M(), z(), N.disconnect();
  }), Mg(function() {
    var u = Q.coreState;
    u === "playing" ? (d(), QA()) : u !== "initial" && (M(), z(), P());
  });
  var J = function() {
    var o = g.getChangedLines();
    o && o.forEach(function(G, F) {
      E("lines", F, hg(G));
    }), E("cursor", hg(g.getCursor())), E("cursorHold", !0), t = void 0;
  }, v = Z(function() {
    var u;
    if (!!Q.charW) {
      console.debug("containerW = ".concat(Q.containerW));
      var o = Q.charW * e() + Q.bordersW, G = Q.charH * i() + Q.bordersH, F = (u = A.fit) !== null && u !== void 0 ? u : "width";
      if (F === "both" || Q.isFullscreen) {
        var L = Q.containerW / Q.containerH, m = o / G;
        L > m ? F = "height" : F = "width";
      }
      if (F === !1 || F === "none")
        return {};
      if (F === "width") {
        var p = Q.containerW / o;
        return {
          scale: p,
          width: Q.containerW,
          height: G * p
        ...
        throw "unsupported fit mode: ".concat(F);
    }
  }), b = function() {
    var o;
    E("isFullscreen", (o = document.fullscreenElement) !== null && o !== void 0 ? o : document.webkitFullscreenElement);
  }, T = function() {
    if (Q.isFullscreen) {
      var o, G;
      ((o = (G = document.exitFullscreen) !== null && G !== void 0 ? G : document.webkitExitFullscreen) !== null && o !== void 0 ? o : function() {
      }).apply(document);
    } else {
      var F, L;
      ((F = (L = h.requestFullscreen) !== null && L !== void 0 ? L : h.webkitRequestFullscreen) !== null && F !== void 0 ? F : function() {
      }).apply(h);
    }
  }, W = function(o) {
    if (!(o.altKey || o.metaKey || o.ctrlKey)) {
      if (o.shiftKey) {
        if (o.key == "ArrowLeft")
          g.seek("<<<");
      ...
      if (o.key == " ")
        ...
        g.seek(">>");
      else if (o.key.charCodeAt(0) >= 48 && o.key.charCodeAt(0) <= 57) {
        var G = (o.key.charCodeAt(0) - 48) / 10;
        g.seek("".concat(G * 100, "%"));
      } else
        return;
      o.preventDefault();
    ...
    var o = g.getCurrentTime(), G = g.getRemainingTime(), F = g.getProgress();
    E({
      currentTime: o,
      remainingTime: G,
      progress: F
    ...
    clearInterval(w), E("blink", !0);
  }, c = function u(o) {
    clearTimeout(n), o && (n = setTimeout(function() {
      return u(!1);
    }, 2e3)), E("showControls", o);
  }, r = function() {
    var o = {};
    (A.fit === !1 || A.fit === "none") && A.terminalFontSize !== void 0 && (A.terminalFontSize === "small" ? o["font-size"] = "12px" : A.terminalFontSize === "medium" ? o["font-size"] = "18px" : A.terminalFontSize === "big" ? o["font-size"] = "24px" : o["font-size"] = A.terminalFontSize);
    var G = v();
    return G === void 0 ? (o.height = 0, o) : (G.width !== void 0 && (o.width = "".concat(G.width, "px"), o.height = "".concat(G.height, "px")), o);
  }, a = function() {
    var o;
    return "asciinema-player asciinema-theme-".concat((o = A.theme) !== null && o !== void 0 ? o : "asciinema");
  }, l = function() {
    var o;
    return (o = v()) === null || o === void 0 ? void 0 : o.scale;
  }, D = function() {
    var u = PI.cloneNode(!0), o = u.firstChild, G = h;
    typeof G == "function" ? G(u) : h = u, u.addEventListener("webkitfullscreenchange", b), u.addEventListener("fullscreenchange", b), u.$$mousemove = sA, u.$$keydown = W, u.addEventListener("keypress", W);
    var F = f;
    return typeof F == "function" ? F(o) : f = o, o.$$mousemove = function() {
      return c(!0);
    }, o.addEventListener("mouseleave", BA), x(o, H(Tg, {
      get cols() {
        return e();
      },
      get rows() {
      ...
      onPlayClick: function() {
        return g.pauseOrResume();
      },
      onFullscreenClick: T,
      onSeekClick: function(m) {
        return g.seek(m);
      }
    }), null), x(o, H(mg, {
      get children() {
      ...
      var m = Q.showControls, p = a(), dA = r();
      return m !== L._v$ && u.classList.toggle("hud", L._v$ = m), p !== L._v$2 && (o.className = L._v$2 = p), L._v$3 = WA(o, dA, L._v$3), L;
    }, {
      _v$: void 0,
      _v$2: void 0,
      _v$3: void 0
...
tg(["keydown", "mousemove"]);
var xA = /* @__PURE__ */ function(A) {
  function g(I, B) {
    TA(this, g), this.input = I, this.xfs = B != null ? B : [];
  }
  return ZA(g, [{
    key: "map",
    value: function(B) {
      return this.transform($I(B));
    }
  }, {
    key: "flatMap",
    value: function(B) {
      return this.transform(AB(B));
    }
  }, {
    key: "filter",
    value: function(B) {
      return this.transform(gB(B));
    }
  }, {
    key: "take",
    value: function(B) {
      return this.transform(IB(B));
    }
  }, {
    key: "drop",
    value: function(B) {
      return this.transform(BB(B));
    }
  }, {
    key: "transform",
    value: function(B) {
      return new g(this.input, this.xfs.concat([B]));
    }
  }, {
    key: "toArray",
    value: function() {
    ...
    key: A,
    value: function() {
      var B = this, C = 0, Q = 0, E = [], e = !1, i = QB(this.xfs, function(t) {
        return E.push(t);
      });
      return {
        next: function() {
          for (Q === E.length && (E = [], Q = 0); E.length === 0 && C < B.input.length; )
            i.step(B.input[C++]);
          return E.length === 0 && !e && (i.flush(), e = !0), E.length > 0 ? {
            done: !1,
            value: E[Q++]
          } : {
            done: !0
...
function QB(A, g) {
  return A.reverse().reduce(function(I, B) {
    var C = Gg(B(I.step));
    return {
      step: C.step,
      flush: function() {
...
function CB(A, g, I) {
  var B = g.feed, C = g.now, Q = g.setTimeout, E = g.onFinish, e = I.idleTimeLimit, i = I.startAt, t, n, s, w, h, f, k = 0, N = 0, y, S;
  function J() {
    return v.apply(this, arguments);
  }
  function v() {
    return v = K(/* @__PURE__ */ R.mark(function d() {
      var M, c, r;
      return R.wrap(function(l) {
        for (; ; )
          switch (l.prev = l.next) {
            ...
            case 2:
              return l.t0 = EB, l.next = 5, b(A);
            case 5:
              if (l.t1 = l.sent, c = (0, l.t0)(l.t1), t = c.cols, n = c.rows, e = (M = e) !== null && M !== void 0 ? M : c.idleTimeLimit, r = rB(c.frames, e, i), s = r.frames, s.length !== 0) {
                l.next = 14;
                break;
              }
              throw "asciicast is missing events";
            case 14:
              h = r.effectiveStartAt, w = s[s.length - 1][0];
            case 16:
            case "end":
              return l.stop();
          }
  ...
  function T() {
    return T = K(/* @__PURE__ */ R.mark(function d(M) {
      var c, r, a, l, D;
      return R.wrap(function(o) {
        for (; ; )
          switch (o.prev = o.next) {
            case 0:
              if (c = M.url, r = M.data, a = M.fetchOpts, l = a === void 0 ? {} : a, c === void 0) {
                o.next = 12;
                break;
              }
              return o.next = 4, fetch(c, l);
            case 4:
              if (D = o.sent, D.ok) {
                o.next = 7;
                break;
              }
              throw "failed fetching asciicast file: ".concat(D.statusText, " (").concat(D.status, ")");
            case 7:
              return o.next = 9, D.text();
            case 9:
            ...
            case 12:
              ...
              return typeof r == "function" && (r = r()), o.next = 16, r;
            case 16:
              return o.abrupt("return", o.sent);
            case 19:
  ...
  function sA() {
    var d = s[k], M;
    do
      B(d[1]), N = d[0] * 1e3, d = s[++k], M = C() - y;
    while (d && M > d[0] * 1e3);
    W();
  }
  function BA() {
    clearTimeout(f), f = null, S = C() - y;
  }
  function QA() {
    y = C() - S, S = null, W();
  }
  function z(d) {
    var M = !!f;
    if (M && BA(), typeof d == "string") {
      var c, r = ((c = S) !== null && c !== void 0 ? c : 0) / 1e3;
      d === "<<" ? d = r - 5 : d === ">>" ? d = r + 5 : d === "<<<" ? d = r - 0.1 * w : d === ">>>" ? d = r + 0.1 * w : d[d.length - 1] === "%" && (d = parseFloat(d.substring(0, d.length - 1)) / 100 * w);
    }
    var a = Math.min(Math.max(d, 0), w) * 1e3;
    a < N && (B("\x1Bc"), k = 0, N = 0);
    for (var l = s[k]; l && l[0] * 1e3 < a; )
      B(l[1]), N = l[0] * 1e3, l = s[++k];
    S = a, M && QA();
  }
  function P(d) {
    for (var M = d * 1e3, c = [], r = 0, a = s[0]; a && a[0] * 1e3 < M; )
      c.push(a[1]), a = s[++r];
    return c;
  }
  return {
    init: function() {
      var d = K(/* @__PURE__ */ R.mark(function c() {
    ...
    getCurrentTime: function() {
      if (f)
        return (C() - y) / 1e3;
      var M;
      return ((M = S) !== null && M !== void 0 ? M : 0) / 1e3;
    }
  };
}
function EB(A) {
  ...
  } else if (hA(A) === "object" && typeof A.version == "number")
    g = A;
  else if (Array.isArray(A))
    g = A[0], I = new xA(A).drop(1);
  else
    throw "invalid data";
  if (g.version === 1)
    return iB(g);
...
`), I;
  ...
  var B = new xA(g).drop(1).filter(function(C) {
    return C[0] === "[";
  }).map(function(C) {
    return JSON.parse(C);
  });
...
function iB(A) {
  var g = 0, I = new xA(A.stdout).map(function(B) {
    return g += B[0], [g, B[1]];
  });
  return {
    cols: A.width,
...
function nB(A) {
  var g = 0.016666666666666666, I;
  return A.transform(function(B) {
    var C = 0, Q = 0;
    return {
      step: function(e) {
        if (C++, I === void 0) {
        ...
        e[0] - I[0] < g ? I[1] += e[1] : (B(I), I = e, Q++);
      },
      flush: function() {
        I !== void 0 && (B(I), Q++), console.debug("batched ".concat(C, " frames to ").concat(Q, " frames"));
      }
    };
  });
}
function rB(A) {
  var g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1 / 0, I = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0, B = 0, C = 0, Q = I, E = Array.from(nB(A).map(function(e) {
    var i = e[0] - B, t = i - g;
    return B = e[0], t > 0 && (C += t, e[0] < I && (Q -= t)), [e[0] - C, e[1]];
  }));
  return {
    frames: E,
    effectiveStartAt: Q
...
function sB(A) {
  var g = A.feed, I = A.setTimeout, B = " ".charCodeAt(0), C = "~".charCodeAt(0) - B, Q, E = function() {
    var t = Math.pow(5, Math.random() * 4);
    Q = I(e, t);
  }, e = function() {
    E();
    var t = String.fromCharCode(B + Math.floor(Math.random() * C));
    g(t);
  };
  return function() {
    return E(), function() {
...
function aB(A, g) {
  var I = A.feed, B = g.cols, C = B === void 0 ? 5 : B, Q = g.rows, E = Q === void 0 ? 1 : Q, e = Math.floor(E / 2), i = Math.floor(C / 2) - 2, t;
  return {
    cols: C,
    rows: E,
    duration: 24 * 60,
    start: function() {
      setTimeout(function() {
        I("\x1B[?25l\x1B[1m\x1B[".concat(e, "B"));
      }, 0), t = setInterval(function() {
        var s = new Date(), w = s.getHours(), h = s.getMinutes();
        I("\r");
        for (var f = 0; f < i; f++)
          I(" ");
        I("\x1B[32m"), w < 10 && I("0"), I("".concat(w)), I("\x1B[39;5m:\x1B[25;35m"), h < 10 && I("0"), I("".concat(h));
      }, 1e3);
    },
    stop: function() {
      clearInterval(t);
...
var cB = /* @__PURE__ */ function() {
  function A() {
    TA(this, A), this.first = void 0, this.last = void 0, this.onPush = void 0;
  }
  return ZA(A, [{
    key: "push",
    value: function(I) {
      ...
      this.last !== void 0 ? this.last = this.last.next = B : this.last = this.first = B, this.onPush && (this.onPush(this.pop()), this.onPush = void 0);
    }
  }, {
    key: "pop",
    value: function() {
      var I = this.first;
      if (I !== void 0)
        return this.first = I.next, this.first === void 0 && (this.last = void 0), I.item;
      var B = this;
    ...
    key: "forEach",
    value: function(I) {
      var B = this, C = !1, Q = /* @__PURE__ */ function() {
        var E = K(/* @__PURE__ */ R.mark(function e() {
          var i;
          return R.wrap(function(n) {
            for (; ; )
              switch (n.prev = n.next) {
                case 0:
                  i = B.pop();
                case 1:
                  if (!(hA(i) !== "object" || typeof i.then != "function")) {
                    n.next = 9;
                    break;
                  }
                  if (!C) {
      ...
      return setTimeout(Q, 0), function() {
        C = !0;
      };
    }
  }]), A;
...
function Zg(A, g) {
  var I = new cB(), B, C = I.forEach(/* @__PURE__ */ function() {
    var Q = K(/* @__PURE__ */ R.mark(function E(e) {
      var i, t;
      return R.wrap(function(s) {
        for (; ; )
          switch (s.prev = s.next) {
            case 0:
              if (i = MA() - B, t = (e[0] + g) * 1e3, !(t > i)) {
                s.next = 5;
                break;
              }
              return s.next = 5, uB(t - i);
            case 5:
              A(e[2]);
            case 6:
            case "end":
...
function lB(A, g) {
  var I = A.url, B = A.bufferTime, C = B === void 0 ? 0 : B, Q = g.feed, E = g.reset, e = g.setWaiting, i = g.onFinish, t = new TextDecoder(), n, s, w = 250, h = !1;
  function f() {
    s !== void 0 && s.stop(), s = Zg(Q, C);
  }
  function k() {
    n = new WebSocket(I), n.binaryType = "arraybuffer", n.onopen = function() {
      console.debug("websocket: opened"), e(!1), f(), w = 250;
    }, n.onmessage = function(N) {
      if (typeof N.data == "string") {
        var y = JSON.parse(N.data);
        if (y.cols !== void 0 || y.width !== void 0) {
          var S, J;
          f(), E((S = y.cols) !== null && S !== void 0 ? S : y.width, (J = y.rows) !== null && J !== void 0 ? J : y.height);
        } else
          s.pushEvent(y);
      } else
        s.pushText(t.decode(N.data));
    }, n.onclose = function(N) {
      h || N.code === 1e3 || N.code === 1005 ? (console.debug("websocket: closed"), i()) : (console.debug("websocket: unclean close, reconnecting in ".concat(w, "...")), e(!0), setTimeout(k, w), w = Math.min(w * 2, 5e3));
    };
  }
  return {
    start: function() {
    ...
    stop: function() {
      h = !0, s !== void 0 && s.stop(), n !== void 0 && n.close();
    }
  };
}
function wB(A, g) {
  var I = A.url, B = A.bufferTime, C = B === void 0 ? 0 : B, Q = g.feed, E = g.reset, e = g.setWaiting, i = g.onFinish, t, n;
  function s() {
    n !== void 0 && n.stop(), n = Zg(Q, C);
  }
  return {
    start: function() {
      t = new EventSource(I), t.addEventListener("open", function() {
        console.debug("eventsource: opened"), e(!1), s();
      }), t.addEventListener("error", function(h) {
        console.debug("eventsource: errored"), console.debug(h), e(!0);
      }), t.addEventListener("message", function(h) {
        var f = JSON.parse(h.data);
        if (f.cols !== void 0 || f.width !== void 0) {
          var k, N;
          s(), E((k = f.cols) !== null && k !== void 0 ? k : f.width, (N = f.rows) !== null && N !== void 0 ? N : f.height);
        } else
          n.pushEvent(f);
      }), t.addEventListener("done", function() {
        console.debug("eventsource: closed"), t.close(), i();
      });
    },
    stop: function() {
      n !== void 0 && n.stop(), t !== void 0 && t.close();
    }
  };
}
function fB(A, g) {
  var I, B = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, C = new RI(hB(A), {
    cols: B.cols,
    rows: B.rows,
    loop: B.loop,
    speed: B.speed,
    ...
    rows: B.rows,
    fit: B.fit,
    autoPlay: (I = B.autoPlay) !== null && I !== void 0 ? I : B.autoplay,
  ...
  return i.addEventListener = function(t, n) {
    return C.addEventListener(t, n.bind(i));
  }, i;
}
function hB(A) {
  typeof A == "string" && (A.substring(0, 5) == "ws://" || A.substring(0, 6) == "wss://" ? A = {
    ...
    driver: "asciicast",
    url: A
  }), A.driver === void 0 && (A.driver = "asciicast");
  var g = /* @__PURE__ */ new Map([["asciicast", CB], ["websocket", lB], ["eventsource", wB], ["test", oB]]);
...
const DB = (A, g) => {
  ...
  setup(A) {
    const g = A, I = Og(null), B = ["asciinema", "monokai", "tango", "solarized-dark", "solarized-light"], C = B[Math.floor(Math.random() * 10 % B.length)];
    return Wg(() => {
      var Q;
      fB(
        g.file || "data:text/plain;base64,eyJ2ZXJzaW9uIjogMiwgIndpZHRoIjogODAsICJoZWlnaHQiOiAyNH0KWzAuMSwgIm8iLCAiaGVsbCJdClswLjUsICJvIiwgIm8gIl0KWzIuNSwgIm8iLCAid29ybGQhXG5cciJdCg==",
        I.value,
        {
          loop: (Q = g.loop) != null ? Q : !1,
          theme: C
        }
      );
    }), (Q, E) => (Xg(), Vg("div", yB, [
...
}, cA = /* @__PURE__ */ DB(GB, [["__scopeId", "data-v-bfca1223"]]);
cA.install = (A) => {
  A.component(cA.__name || cA.__name, cA);
};
const dB = [cA], kB = (A) => {
  dB.forEach((g) => {
    A.component(g.__name, g);
  });
}, FB = {
  install: kB
};
